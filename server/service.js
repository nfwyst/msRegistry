...
module.exports = (config) => {
  ...
  service
    .put('/microservice/register/:name/:version/:port', (req, res) => {
    ...
    .delete('/microservice/register/:name/:version/:port', (req, res) => {
      const { name, version, port } = req.params
      const addr = req.connection.remoteAddress
      const ip = addr.includes('::') ? `[${addr}]` : addr
    ...
    .get('/microservice/find/:name/:version', (req, res, next) => {
